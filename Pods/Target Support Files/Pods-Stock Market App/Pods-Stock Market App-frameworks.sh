...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "${BUILT_PRODUCTS_DIR}/ASATools/ASATools.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/CustomerIOCommon/CioInternalCommon.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/CustomerIOMessagingInApp/CioMessagingInApp.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/CustomerIOMessagingPush/CioMessagingPush.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/CustomerIOMessagingPushAPN/CioMessagingPushAPN.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/CustomerIOMessagingPushFCM/CioMessagingPushFCM.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/CustomerIOTracking/CioTracking.framework"
